        ...
        {activeTab === 'content' && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <button className="btn-outline" onClick={() => navigate('/admin/movies')}>Manage Movies</button>
              <button className="btn-outline" onClick={() => setActiveTab('reports')}>Review Reports</button>
              <button className="btn-outline" onClick={() => navigate('/admin/discussions')}>Moderate Discussions</button>
              <button className="btn-outline" onClick={() => navigate('/admin/analytics')}>Analytics</button>
            </div>
          </div>
        )}
